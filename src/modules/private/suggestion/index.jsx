...
export const Suggestion = () => {
  ...
  return (
    <main className="w-full min-h-screen bg-grey-50 dark:bg-grey-950">
      <div className="xl:max-w-[1110px] xl:px-0 xl:mx-auto md:flex md:flex-col md:gap-10 xl:flex-row xl:items-start xl:gap-[15px] md:px-10 md:pt-10 md:pb-[113px]  xl:pb-[129px]">
        <Sidebar />
